...
export const Chart: FC<{ data: ChartData[], className?: string }> = ({ data, className }) => {
    ...
    return (
        <StyledChart ref={chartContainerRef as React.RefObject<HTMLDivElement>} className={className}></StyledChart>
    )
}
